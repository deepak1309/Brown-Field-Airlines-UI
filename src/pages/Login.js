...
let handlelog=(e)=>{
 ...
 login(Loggin).then((res)=>{
  ...
  return (
    <div className='login'>
        <div>
    <img src={travel} style={{width:"660px", height:"470px", marginLeft:"5px", marginTop:"0.5%"}}/>
</div>
    <div class="login-container">
    <form>
    <input value={Loggin.loginId}  type="text" placeholder="Username" name="loginId" onChange={handleId} required/>
    <br/>
    <input value={Loggin.password}  type="text" placeholder="Password" name="password" autoComplete="password"  onChange={handleId}  required/>
    <br/>
    <button type="submit" class="btn btn-primary" onClick={handlelog}>Login</button>
    <br>
    </br>
